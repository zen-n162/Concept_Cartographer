...
Usage:
    python -m cc_core.render fixtures/layout_plan_min.json [--url URL]
        [--no-clear] [--no-verify] [--export-dir exports]
...
def main() -> None:
    ...
    parser.add_argument("plan", help="path to layout_plan.json")
